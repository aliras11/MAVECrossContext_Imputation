"""Measure losses on MICE PMM outputs from no-double-missing splits.

Usage:
    python loss_measure_mice_no_double_missing.py
    python loss_measure_mice_no_double_missing.py --target av12 --rates 10 40
"""
...
if __name__ == "__main__":
    ...
    for target in args.target:
        ...
        for r in args.rates:
            ...
            mice_model_out = tgt_dir / f"mice_test_frac_{r}"
    ...
    if all_results:
        ...
        combined_results.to_csv(output_dir / "mice_loss_no_double_missing.csv", index=False)
        print(f"Saved to {output_dir / 'mice_loss_no_double_missing.csv'}")
    else:
