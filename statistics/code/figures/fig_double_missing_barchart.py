"""Double Missing — Grouped Bar Chart with best-model significance marker"""
...
def main(
    ...
    for i, model in enumerate(order):
        ...
        display = fh.get_task_display_name(model, "double_missing")
    ...
    ax.set_title(r'Between-Map: Missing-Source ($B_0$)', fontsize=20)
    ax.set_xticks(x)
    ...
    plt.tight_layout()
    fh.save_figure(fig, f'double_missing_barchart{suffix}', output_dir)
